...
{
    public class UncontrolledSprite
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(m_texture,
                ...
                new Rectangle(
                    ...
                    m_frameSize.X,
                    m_frameSize.Y),
                Color.FromNonPremultiplied(m_tint.R, m_tint.B, m_tint.G, m_opacity),
                m_rot,
                new Vector2(
        ...
        /// <summary>Creates a 2d array of colors</summary>
