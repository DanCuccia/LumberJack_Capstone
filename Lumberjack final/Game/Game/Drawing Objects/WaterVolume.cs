...
namespace Game.Drawing_Objects
{
    ...
    public class WaterSettings
    {
        ...
        public static WaterSettings GetSettingsTwo()
        {
            WaterSettings settings = new WaterSettings();
            settings.TextureScale = new Vector2(40, 40);
            settings.BumpSpeed = new Vector2(0.0001f, 0.0005f);
            settings.DeepColor = MyColors.Water_DarkDeepBlue;
            settings.ShallowColor = MyColors.Water_DarkShallowBlue;
            settings.ReflectionAmount = .2f;
            settings.WaterAmount = .3f;
            return settings;
        }
    }
