...
namespace Game.Math_Physics
{
    public class Collision
    {
        ...
        public static bool RectangleCollision2D(UncontrolledSprite one, UncontrolledSprite two)
        {
        ...
        public static bool DistanceCollision2D(UncontrolledSprite one, UncontrolledSprite two, double offset = 0.0)
        {
